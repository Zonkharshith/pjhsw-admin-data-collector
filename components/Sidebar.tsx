...
export const Sidebar: React.FC<SidebarProps> = ({ yearlyData }) => {
  // We can calculate total here for a quick glance if needed, but primarily this is now just the Right Panel
  return (
