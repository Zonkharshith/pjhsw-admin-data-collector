...
import { CommitmentRow, Status } from '../types';
import { analyzeTranscript } from '../services/geminiService';

interface CommitmentTableProps {
  rows: CommitmentRow[];
  setRows: React.Dispatch<React.SetStateAction<CommitmentRow[]>>;
  readOnly?: boolean;
  filterToday?: boolean;
}

export const CommitmentTable: React.FC<CommitmentTableProps> = ({ rows, setRows, readOnly = false, filterToday = false }) => {
  ...
  const updateRow = (id: string, field: keyof CommitmentRow, value: any) => {
  ...
  const handleAnalyze = async (row: CommitmentRow) => {
